    ...
    return (
        <>
            <div className='container flex justify-center items-center h-screen md:grid md:grid-cols-2  gap-8 '>
                <div className=''>
                    <div className='bg-primary-light py-12 px-8 rounded-lg'>
                ...
                <div className='flex justify-center items-center'>
                    <div className='space-y-3 w-10/12'>
                        <p className='text-5xl font-bold text-primary-light' >Welcome</p>
                        <p className='text-5xl font-bold text-secondary' >I'm Artistic Sophia</p>
                        <p className='text-xl text-primary-light font-semibold'>I'm a passionate digital artist, spending my days (and often nights) bringing imagination to life on a digital canvas. With every stroke and shade, I transform pixels into immersive, expressive worlds.</p>
                    </div>
